export const translations = {
  en: {
    ...
    science: {
      ...
      subtitle:
        "Every thought, lift, and movement runs on one thing - energy. Creatine is your body's natural power reserve, recycling ATP, the fuel for your muscles and brain. When ATP drops, fatigue hits - but with higher creatine levels, performance lasts longer. Sharper focus, stronger lifts and faster recovery with C-Tine.",
      buttonText: null,
    },
    why: {
      title: "Why C-TINE?",
  ...
  ar: {
    ...
    science: {
      ...
      subtitle:
        "كل فكرة، رفع، وحركة تعمل على شيء واحد - الطاقة. الكرياتين هو احتياطي الطاقة الطبيعي لجسمك، إعادة تدوير ATP، وقود عضلاتك ودماغك. عندما ينخفض ATP، يضرب الإرهاق - لكن مع مستويات أعلى من الكرياتين، يدوم الأداء أطول. تركيز أكثر حدة، رفع أقوى وتعافي أسرع مع C-Tine.",
      buttonText: null,
    },
    why: {
      title: "لماذا C-TINE؟",
